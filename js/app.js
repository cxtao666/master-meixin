window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	nettyServerUrl: 'ws://139.159.148.152:8088/ws',

	/**
	 * 后端服务发布的url地址
	 */
	serverUrl: 'http://im.ganganmaster.top/meiim',
	...
	cunrushuju: function(user) {



		var userInfoStr = user;
		console.log(userInfoStr.id);
		...
		plus.sqlite.executeSql({
			name: 'shuju',
			sql: 'create table if not exists  yonghu(id varchar(255),username varchar(255),faceImage varchar(255) ,faceImageBig varchar(255), nickname  varchar(255),  qrcode  varchar(255))',
			success: function(e) {
				console.log(JSON.stringify(e))
			},
			fail: function(e) {
		...
		plus.sqlite.executeSql({
			name: 'shuju',
			sql: "insert into yonghu values(  '"+userInfoStr.id+"', '"+userInfoStr.username+"'  ,  '"+userInfoStr.faceImage+"' ,  '"+userInfoStr.faceImageBig+"', '"+userInfoStr.nickname+"', '"+userInfoStr.qrcode+"' )",
			success: function(e) {
				console.log(JSON.stringify(e))
				console.log('11');
			},
